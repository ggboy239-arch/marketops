...
GOV_POWER_COMMANDS = [
    "power", "govpower", "fedpower", "branchwatch", "lawwatch", "courtwatch", "rulewatch",
    "powerpost", "govpost", "branchpost",
    "powerstatus", "govstatus", "branchstatus",
...
async def load():
    ...
    await bot.load_extension("cogs.toy_trends")
